#ifndef INPUTMATRIXMEMORY_H 
#define INPUTMATRIXMEMORY_H
...
*
 */
class InputMatrixMemory : public InputMatrix {
	public:
		//Constructor.  Initializes the class variables
		InputMatrixMemory( double * A, long long maxMemoryBytes, int m, int n, std::string p);
